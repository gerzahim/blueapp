    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Create Customer</h4>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="ein_number" name="ein_number" value="{{ old('ein_number') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Resale Tax</label>
                                            <input type="text" class="form-control" id="resale_tax" name="resale_tax" value="{{ old('resale_tax') }}">
                                        </div>
                                    </div>
                                </div>
