                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input
                            ...
                            id="product_name"
                            name="name"
                            v-model="form_modal_product_name"
                      ...
                      <div class="col-md-8">
                        <div class="form-group">
                          ...
                          <input
                            ...
                            name="description"
                            v-model="form_modal_product_description"
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select
                            ...
                            class="form-control form-control-sm"
                            v-model="form_modal_product_dimension"
                          >
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select
                            ...
                            class="form-control form-control-sm"
                            v-model="form_modal_product_category"
                          >
  ...
  methods: {
    ...
    addNewProduct() {
      ...
      if (
        ...
        toastr.error(
          "Please Select a Product Dimension !",
          "Error Alert",
          this.options_toastr
        );
        return;
